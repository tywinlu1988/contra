...
**当前版本：Contra Free。** 全部核心审查功能免费开放、无需账号：挑刺内核、七家供应商 BYOK、每日 10 次。

**Contra Pro —— 即将推出（$9 终身买断）**：三核全开（盲区猎犬 + 立论锻造师）、不限次数、自定义端点、口令金库。由合规 MoR 平台收银，卡密邮件交付。扩展中已内置"激活 Pro"入口，当前标注"即将上线"，收银台开放后即开卖。
